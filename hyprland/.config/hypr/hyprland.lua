...
hl.bind("SHIFT + Print", hl.dsp.exec_cmd("grim ~/Pictures/Screenshots/screenshot-$(date +%Y-%m-%d_%H-%M-%S).png"))

hl.bind(mainMod .. " + F12", hl.dsp.exec_cmd('grim -g "$(slurp)" - | wl-copy'))
hl.bind(mainMod .. " + SHIFT + F12", hl.dsp.exec_cmd("grim - | wl-copy"))
...
hl.bind(mainMod .. " + CTRL + SHIFT + left", hl.dsp.window.move({ monitor = "left" }))
hl.bind(mainMod .. " + CTRL + SHIFT + right", hl.dsp.window.move({ monitor = "right" }))
hl.bind(mainMod .. " + CTRL + SHIFT + up", hl.dsp.window.move({ monitor = "up" }))
hl.bind(mainMod .. " + CTRL + SHIFT + down", hl.dsp.window.move({ monitor = "down" }))
...
hl.bind(mainMod .. " + MINUS", hl.dsp.window.resize({ x = -resizeUnit, y = 0, relative = true }))
hl.bind(mainMod .. " + EQUAL", hl.dsp.window.resize({ x = resizeUnit, y = 0, relative = true }))
hl.bind(mainMod .. " + SHIFT + MINUS", hl.dsp.window.resize({ x = 0, y = -resizeUnit, relative = true }))
hl.bind(mainMod .. " + SHIFT + EQUAL", hl.dsp.window.resize({ x = 0, y = resizeUnit, relative = true }))
...
hl.bind(mainMod .. " + CTRL + period", hl.dsp.window.move({ workspace = "current" }))
...
hl.bind(mainMod .. " + F4", hl.dsp.exec_cmd("brightnessctl -e4 -n2 set 5%-"), { locked = true, repeating = true })
hl.bind(mainMod .. " + F5", hl.dsp.exec_cmd("brightnessctl -e4 -n2 set 5%+"), { locked = true, repeating = true })
hl.bind(mainMod .. " + F6", hl.dsp.exec_cmd("playerctl previous"), { locked = true })
hl.bind(mainMod .. " + F7", hl.dsp.exec_cmd("playerctl play-pause"), { locked = true })
hl.bind(mainMod .. " + F8", hl.dsp.exec_cmd("playerctl next"), { locked = true })
hl.bind(
	mainMod .. " + F9",
	hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle"),
	{ locked = true, repeating = true }
